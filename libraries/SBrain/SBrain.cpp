...
SBrain::SBrain(SoftwareSerial &_brainSerial) {
...
void SBrain::clearPacket() {
	for (byte i = 0; i < MAX_PACKET_LENGTH; i++) {
		packetData[i] = 0;
	}
}

void SBrain::clearEegPower() {
...
byte SBrain::readSignalQuality() {
	return signalQuality;
}

byte SBrain::readAttention() {
	return attention;
}

byte SBrain::readMeditation() {
	return meditation;
}

unsigned long* SBrain::readPowerArray() {
	return eegPower;
}

unsigned long SBrain::readDelta() {
	return eegPower[0];
}

unsigned long SBrain::readTheta() {
	return eegPower[1];
}

unsigned long SBrain::readLowAlpha() {
	return eegPower[2];
}

unsigned long SBrain::readHighAlpha() {
	return eegPower[3];
}

unsigned long SBrain::readLowBeta() {
	return eegPower[4];
}

unsigned long SBrain::readHighBeta() {
	return eegPower[5];
}

unsigned long SBrain::readLowGamma() {
	return eegPower[6];
}

unsigned long SBrain::readMidGamma() {
	return eegPower[7];
}